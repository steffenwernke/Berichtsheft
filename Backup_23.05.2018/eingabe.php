...
<html>
   ...
   <body>
		...
		<textarea rows="10" cols="45" maxlength="400" type="text" name="betrieb" placeholder="Betriebliche Tätigkeiten eingeben"><?php echo $TextBetrieblich ?></textarea><br/><label> Betriebliche Tätigkeiten</label><br></br>
		<textarea rows="10" cols="45" maxlength="400" type="text" name="theorie" placeholder="Theorie Themen eingeben"><?php echo $TextTheorie ?></textarea><br/><label> Theorie Themen</label><br></br>
