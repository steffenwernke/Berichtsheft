...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 28. Apr 2018 um 15:07
...
(1, 1, 'Steffen Wernke', 'IT', 1, 'test1', 'test2', '2018-04-23', '2018-04-27', '2018-04-27', 3, 1);
...
--
ALTER TABLE `eintraege`
  MODIFY `ENr` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
