...
if(isset($_POST['submit2']) && $_POST['date'] == true){
	...
	for($j1 = 0; $j1 < count($ENr1); $j1++){
		...
		echo "<a href='./ausgabe.php?ENr=$ENr1[$j1]&TName=$Teilnehmername1[$j1]&Date=$auswahldate'>$Teilnehmername1[$j1]</a>";
		if(count($ENr1) > 1){
		echo ", ";
		}
	}
...
if(isset($_POST['submit2']) && $_POST['date'] == true){
	...
	echo "<a href='./ausgabe.php?ENr=$ENr2[$j2]&TName=$Teilnehmername2[$j2]&Date=$auswahldate'>$Teilnehmername2[$j2]</a>";
		if(count($ENr2) > 1){
		echo ", ";
		}
	}
...
if(isset($_POST['submit2']) && $_POST['date'] == true){
	...
	for($j3 = 0; $j3 < count($ENr3); $j3++){
		...
		echo "<a href='./ausgabe.php?ENr=$ENr3[$j3]&TName=$Teilnehmername3[$j3]&Date=$auswahldate'>$Teilnehmername3[$j3]</a>";
		if(count($ENr3) > 1){
		echo ", ";
		}
	}
