...
if(isset($_POST['submit1']) && $_POST['name1'] == true){
	...
	$name1 = $_POST['name1'];
	$query1 ="SELECT ENr, AusbildungsWocheBeginn FROM eintraege, teilnehmer WHERE eintraege.TNr = teilnehmer.TNr AND teilnehmer.Tname = '$name1' AND EStatus = 0";
	...
	for($j = 0; $j < count($ENr); $j++){
		...
		echo "<a href='./ausgabe.php?ENr=$ENr[$j]'>$ENr[$j]</a>";
		echo ", <br>";
...
if(isset($_POST['submit2']) && $_POST['date1'] == true){
	...
	$query2 ="SELECT TName, ENr FROM eintraege, teilnehmer WHERE eintraege.TNr = teilnehmer.TNr AND ('$auswahldate1' BETWEEN eintraege.AusbildungsWocheBeginn AND eintraege.AusbildungsWocheEnde)AND EStatus = 0";
...
if(isset($_POST['submit3']) && $_POST['name2'] == true){
	...
	$name2 = $_POST['name2'];
	$query3 ="SELECT ENr, AusbildungsWocheBeginn FROM eintraege, teilnehmer WHERE eintraege.TNr = teilnehmer.TNr AND teilnehmer.Tname = '$name2' AND EStatus = 1";
...
if(isset($_POST['submit4']) && $_POST['date2'] == true){
	...
	$query4 ="SELECT TName, ENr FROM eintraege, teilnehmer WHERE eintraege.TNr = teilnehmer.TNr AND ('$auswahldate2' BETWEEN eintraege.AusbildungsWocheBeginn AND eintraege.AusbildungsWocheEnde)AND EStatus = 1";
...
if(isset($_POST['submit5']) && $_POST['name3'] == true){
	$name3 = $_POST['name3'];
	$query5 ="SELECT ENr, AusbildungsWocheBeginn FROM eintraege, teilnehmer WHERE eintraege.TNr = teilnehmer.TNr AND teilnehmer.Tname = '$name3' AND EStatus = 2";
...
if(isset($_POST['submit6']) && $_POST['date3'] == true){
	...
	$query6 ="SELECT TName, ENr FROM eintraege, teilnehmer WHERE eintraege.TNr = teilnehmer.TNr AND ('$auswahldate3' BETWEEN eintraege.AusbildungsWocheBeginn AND eintraege.AusbildungsWocheEnde)AND EStatus = 2";
