...
<html>
   ...
   <body>
		<h2 class="padding" >Abgegebene Eintraege ansehen</h2> 
  ...
  <div class="container-fluid">
    <ul class="nav navbar-nav">
      ...
      <li><a href="./ausbilder_fertige.php">Fertige Eintraege ansehen</a></li>
		...
		<br></br>
		<div class="padding textblue1">Hier können Sie die abgegebenen Einträge der Teilnehmer nach Name oder Datum filtern</div>
		<br></br>
