...
<html>
   ...
   <body>
		...
		<form class="padding" method='POST' action='teilnehmer_menue.php?ENr=<?php echo $ENr?>'>
		...
		<textarea rows="10" cols="45" maxlength="1500" type="text" name="betrieb" placeholder="Betriebliche Tätigkeiten eingeben"><?php echo $TextBetrieblich ?></textarea><br/><label> Betriebliche Tätigkeiten</label><br></br>
		<textarea rows="10" cols="45" maxlength="1500" type="text" name="theorie" placeholder="Theorie Themen eingeben"><?php echo $TextTheorie ?></textarea><br/><label> Theorie Themen</label><br></br>
